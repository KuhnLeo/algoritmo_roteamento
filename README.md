...
# Tracking
**1 - Efetuado instalação do Ubuntu 26.04.1 LTS via Virtual Box, atualizado pacotes pelo terminal e instalado docker e baixado a imagem do frrouting e alpine (imagem é mais leve que a do FRRouting, 13mb vs 230mb)**
